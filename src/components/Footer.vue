<template>
  <div class="container-fluid text-center mt-3">
    ...
    <a target="_blank" href="https://ionic.money">Built for Ionic</a>
  </div>

  <div class="container-fluid text-center">

    <a class="icons" target="_blank" href="https://github.com/ionicprotocol"><i class="bi bi-github"></i></a>

    <a class="icons" target="_blank" href="https://discord.gg/FmgedqR9wn"><i class="bi bi-discord"></i></a>

    <a class="icons" target="_blank" href="https://t.me/ionicmoney"><i class="bi bi-telegram"></i></a>

    <a class="icons" target="_blank" href="https://www.linkedin.com/company/ionicmoney"><i class="bi bi-linkedin"></i></a>

    <a class="icons" target="_blank" href="https://twitter.com/ionicmoney"><i class="bi bi-twitter"></i></a>
